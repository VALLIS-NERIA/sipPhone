                                                   ...
                                                   int recorderMask) 
{
    ...
    double duration = 0 ;
    int dtmf = 0 ;
    //ProfitFuel used code until 9/8/2006
    //char *szFileMic = new char[255];
    //char *szFileSpkr = new char[255];
    //strncpy_s(szFileMic, 255, szFile, 255);
    //strncpy_s(szFileSpkr, 255, szFile, 255);
    //strncat_s(szFileMic, 255, "-mic", 4);
    //strncat_s(szFileSpkr, 255, "-spkr", 5);
    //return mpFlowGraph->record(0,36000, szFileMic, NULL, szFileSpkr) ;

    //Origional code
    //return mpFlowGraph->record(1, -1, NULL, NULL, szFile) ;
    

    return mpFlowGraph->Record(0, "", szFile, "", recorderMask);
}
