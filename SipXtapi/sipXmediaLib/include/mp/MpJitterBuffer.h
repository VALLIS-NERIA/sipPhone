...
// CONSTANTS
   ...
   static const int JbLatencyInit = 1 ; //We really want to dejitter before the decode,  Origional value = 5
...
private:
   ...
   int volatile JbQWait;  // fixed latency delay control
   int volatile JbQCount; 
   int JbQIn;
   int volatile JbQOut;
