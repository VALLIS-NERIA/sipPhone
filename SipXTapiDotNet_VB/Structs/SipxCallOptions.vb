...
'
Public Structure SipxCallOptions
  Public Size As UInteger               ' Size of structure     
  Public Bandwidth As SipxAudioBandwidth   ' Bandwidth range           
  Public SendLocation As Boolean       ' True sends location header 
End Structure
