...
'
Public Enum SipxAecMode
  Disabled
  Suppress 'Half Duplex, turns off mic when not speaking.
  Cancel   'Full Duplex Echo Cancelation
  CancelAuto  'Full Duplex Echo cancelation only if need detected.
End Enum
